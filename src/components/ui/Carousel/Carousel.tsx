...
const CarouselControl = ({
  ...
  return (
    <button
      className={`cursor-pointer w-10 h-10 flex items-center mx-2 justify-center bg-neutral-800 border-3 border-transparent rounded-full focus:border-primary-ja focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
