...
export default function HalfGuardPage() {
  ...
  return (
    <main>
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mx-2 lg:mx-auto">
                ...
                >
                  ...
                  <p className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-half-guard-theme px-4 text-md font-medium text-white-theme backdrop-blur-3xl">
      ...
      <section
        id="callAction"
        className="py-8 lg:py-16 bg-half-guard-theme-dark text-white-theme"
      >
        <div className=" text-center">
          ...
          <p className="text-xl lg:text-2xl mb-4 max-w-2xl mx-auto">
            ...
            <s className="text-white-theme">R$ 147,00</s>
          </p>
          ...
          <div className="mb-8">
            ...
            <div className="text-xl text-white-theme">ou 8x R$ 8,82</div>
          </div>
